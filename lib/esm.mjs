...
export const GetBatteryInformation = module.GetBatteryInformation;
export const GetCapabilities = module.GetCapabilities;
...
export const identifyAllConnectedDevices = module.identifyAllConnectedDevices;
