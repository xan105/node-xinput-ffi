...
import { shouldInteger } from "@xan105/is/assert";
import { THUMB_MAX } from "../data/Controller.js";

function normalizeThumb(x, y, deadzone, directionThreshold) {
  shouldInteger(x, "X is not an integer !");
  shouldInteger(y, "Y is not an integer !");
  shouldInteger(deadzone, "deadzone is not an integer !");
