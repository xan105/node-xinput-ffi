...
const { stdcall } = load(); //calling convention to call Win32 API functions.
...
//const XInputGetAudioDeviceIds = call("XInputGetAudioDeviceIds", "void", [DWORD, koffi.pointer(WSTRING), koffi.pointer("uint"), koffi.pointer(WSTRING), koffi.pointer("uint")]);
...
//const XInputGetDSoundAudioDeviceGuids = call("XInputGetDSoundAudioDeviceGuids", DWORD, [DWORD, GUID*, GUID*]);
...
const XInputSetState = call("XInputSetState", DWORD, [DWORD, koffi.pointer(XINPUT_VIBRATION)]);
